...
ASSERT_EQ(RoomType::EMPTY, lvl
.start->roomType);
lvl.
start = lvl.start->next;
ASSERT_EQ(RoomType::MONSTER, lvl
.start->roomType);
lvl.
start = lvl.start->next;
ASSERT_EQ(RoomType::TREASURE, lvl
.start->roomType);
}
...
getCurrentRoom(), RoomType::MONSTER
...
getCurrentRoom(), RoomType::TREASURE
